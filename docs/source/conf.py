# -*- coding: utf-8 -*-
#
# Tale documentation build configuration file, created by
...
# of the sidebar.
html_logo = "_static/tale-small.png"
...
# deprecated, now uses setting from docutils.conf
