...
_races = {
 'amphibian': {'body': BodyType.QUADRUPED,
               ...
               'stats': {'agi': (10, 4),
                         ...
                         'str': (1, 5),
                         'wis': (43, 1)}},
 'android': {'body': BodyType.HUMANOID,
             'language': 'English',
             'mass': 120.0,
             ...
             'stats': {'agi': (50, 3),
                       ...
                       'str': (50, 4),
                       'wis': (50, 3)}},
 'ape': {'body': BodyType.SEMI_BIPEDAL,
         'language': 'Ur',
         'mass': 120.0,
         'size': BodySize.LARGE,
         'stats': {'agi': (30, 5),
                   ...
                   'str': (43, 1),
                   'wis': (1, 2)}},
 'arachnid': {'body': BodyType.INSECTOID,
              'language': 'Arachnid',
              'mass': 0.2,
              'size': BodySize.TINY,
              'stats': {'agi': (43, 1),
                        ...
                        'str': (10, 4),
                        'wis': (1, 5)}},
 'artrell': {'body': BodyType.INSECTOID,
             'language': 'Artrexcian',
             'mass': 48.0,
             ...
             'stats': {'agi': (50, 1),
                       ...
                       'str': (10, 3),
                       'wis': (5, 5)}},
 'avidryl': {'body': BodyType.WINGED_MAN,
             'language': 'Avidryl',
             'mass': 60.0,
             'size': BodySize.HUMAN_SIZED,
             'stats': {'agi': (50, 1),
                       ...
                       'str': (40, 2),
                       'wis': (10, 5)}},
 'balrog': {'body': BodyType.WINGED_MAN,
            'language': 'Balrog',
            'mass': 1200.0,
            ...
            'stats': {'agi': (40, 1),
                      ...
                      'str': (30, 3),
                      'wis': (10, 3)}},
 'bat': {'body': BodyType.CHIROPTEROID,
         'language': 'Murcielago',
         'mass': 0.4,
         'size': BodySize.VERY_SMALL,
         'stats': {'agi': (10, 2),
                   ...
                   'str': (13, 4),
                   'wis': (10, 5)}},
 'bear': {'body': BodyType.SEMI_BIPEDAL,
          'language': 'Ursine',
          'mass': 160.0,
          'size': BodySize.LARGE,
          'stats': {'agi': (1, 5),
 ...
 'bot': {'body': BodyType.ORB,
         ...
         'stats': {'agi': (50, 3),
                   ...
                   'str': (50, 4),
                   'wis': (50, 3)}},
 'bugbear': {'body': BodyType.SEMI_BIPEDAL,
 ...
 'cat': {'body': BodyType.QUADRUPED,
         ...
         'stats': {'agi': (43, 1),
                   ...
                   'str': (10, 4),
                   'wis': (10, 4)}},
 'centaur': {'body': BodyType.SEMI_BIPEDAL,
             'language': 'Centaurian',
             'mass': 120.0,
             'size': BodySize.LARGE,
             'stats': {'agi': (21, 3),
                       ...
                       'str': (31, 2),
                       'wis': (31, 2)}},
 'chimera': {'body': BodyType.CHIMAERA,
             'language': 'Chimerole',
             'mass': 20.0,
             'size': BodySize.LARGE,
             'stats': {'agi': (31, 2),
 ...
 'cow': {'body': BodyType.QUADRUPED,
         ...
         'stats': {'agi': (1, 5),
                   ...
                   'str': (31, 2),
                   'wis': (1, 5)}},
 'dark-elf': {'body': BodyType.HUMANOID,
              'language': 'Edhellen',
              'mass': 60.0,
              'size': BodySize.HUMAN_SIZED,
              'stats': {'agi': (40, 3),
 ...
 'deer': {'body': BodyType.QUADRUPED,
          ...
          'stats': {'agi': (21, 3),
                    ...
                    'str': (43, 1),
                    'wis': (1, 5)}},
 'demi-god': {'body': BodyType.HUMANOID,
              'language': 'Sublime',
              'mass': 80.0,
              'size': BodySize.HUMAN_SIZED,
              'stats': {'agi': (31, 2),
                        ...
                        'str': (31, 2),
                        'wis': (31, 2)}},
 'demon': {'body': BodyType.WINGED_MAN,
           'language': 'Demoniac',
           'mass': 10.0,
 ...
 'dog': {'body': BodyType.QUADRUPED,
         ...
         'stats': {'agi': (21, 3),
                   ...
                   'str': (21, 3),
                   'wis': (1, 5)}},
 'dragon': {'body': BodyType.SEMI_BIPEDAL,
            'language': 'Dragonate',
            'mass': 1600.0,
            'size': BodySize.HUGE,
            'stats': {'agi': (43, 1),
 ...
 'dwarf': {'body': BodyType.HUMANOID,
           ...
           'stats': {'agi': (10, 2),
                     ...
                     'str': (40, 1),
                     'wis': (20, 3)}},
 'elemental': {'body': BodyType.NEBULOUS,
               'language': 'Periodict',
               'mass': 1600.0,
               'size': BodySize.LARGE,
               'stats': {'agi': (21, 3),
                         ...
                         'str': (21, 3),
                         'wis': (21, 3)}},
 'elephant': {'body': BodyType.QUADRUPED,
 ...
 'elf': {'body': BodyType.HUMANOID,
         ...
         'stats': {'agi': (40, 3),
                   ...
                   'str': (15, 5),
                   'wis': (50, 1)}},
 'faerie': {'body': BodyType.WINGED_MAN,
            'language': 'Elcharean',
            'mass': 0.2,
            'size': BodySize.TINY,
            'stats': {'agi': (60, 1),
 ...
 'fish': {'body': BodyType.FISH,
          ...
          'stats': {'agi': (31, 2),
                    ...
                    'str': (10, 4),
                    'wis': (21, 3)}},
 'gargoyle': {'body': BodyType.WINGED_MAN,
 ...
 'golem': {'body': BodyType.HUMANOID,
           ...
           'stats': {'agi': (21, 3),
                     ...
                     'str': (43, 1),
                     'wis': (31, 2)}},
 'griffin': {'body': BodyType.SEMI_BIPEDAL,
             'language': 'Griffinish',
             'mass': 120.0,
             'size': BodySize.LARGE,
             'stats': {'agi': (31, 2),
                       ...
                       'str': (43, 1),
                       'wis': (10, 4)}},
 'half-elf': {'body': BodyType.HUMANOID,
              'language': 'Edhellen',
              'mass': 60.0,
              'size': BodySize.HUMAN_SIZED,
              'stats': {'agi': (30, 2),
                        ...
                        'str': (15, 3),
                        'wis': (30, 2)}},
 'half-orc': {'body': BodyType.HUMANOID,
              'language': 'Tangetto',
              'mass': 80.0,
              'size': BodySize.HUMAN_SIZED,
              'stats': {'agi': (2, 1),
                        ...
                        'str': (20, 2),
                        'wis': (10, 5)}},
 'halfling': {'body': BodyType.HUMANOID,
              'language': 'Duuk',
              'mass': 20.0,
              'size': BodySize.SMALL,
              'stats': {'agi': (40, 2),
 ...
 'human': {'body': BodyType.HUMANOID,
           ...
           'stats': {'agi': (33, 3),
                     ...
                     'str': (20, 3),
                     'wis': (40, 3)}},
 'insect': {'body': BodyType.INSECTOID,
            'language': 'Insectoid',
            'mass': 0.04,
 ...
 'kender': {'body': BodyType.HUMANOID,
            ...
            'stats': {'agi': (40, 3),
                      ...
                      'str': (3, 5),
                      'wis': (7, 4)}},
 'klingon': {'body': BodyType.HUMANOID,
             'language': 'Tlhinghan',
             'mass': 100.0,
             'size': BodySize.SOMEWHAT_LARGE,
             'stats': {'agi': (30, 2),
 ...
 'kobold': {'body': BodyType.HUMANOID,
            ...
            'stats': {'agi': (21, 3),
                      ...
                      'str': (43, 1),
                      'wis': (10, 4)}},
 'lizard': {'body': BodyType.QUADRUPED,
            'language': 'Reptilian',
            'mass': 0.4,
            'size': BodySize.VERY_SMALL,
            'stats': {'agi': (21, 3),
 ...
 'orc': {'body': BodyType.HUMANOID,
         ...
         'stats': {'agi': (10, 2),
                   ...
                   'str': (35, 1),
                   'wis': (3, 5)}},
 'pegasus': {'body': BodyType.QUADRUPED,
             'language': 'Voloquine',
             'mass': 120.0,
             'size': BodySize.LARGE,
             'stats': {'agi': (43, 1),
 ...
 'plant': {'body': BodyType.PLANT,
           ...
           'stats': {'agi': (1, 5),
                     ...
                     'str': (21, 3),
                     'wis': (1, 5)}},
 'primate': {'body': BodyType.SEMI_BIPEDAL,
             'language': 'Proto',
             'mass': 60.0,
             'size': BodySize.SMALL,
             'stats': {'agi': (21, 3),
                       ...
                       'str': (10, 4),
                       'wis': (10, 4)}},
 'replicant': {'body': BodyType.HUMANOID,
               'language': 'English',
               'mass': 72.0,
               'size': BodySize.HUMAN_SIZED,
               'stats': {'agi': (40, 3),
                         ...
                         'str': (40, 4),
                         'wis': (1, 3)}},
 'rodent': {'body': BodyType.QUADRUPED,
            'language': 'Rodentian',
            'mass': 0.4,
            'size': BodySize.VERY_SMALL,
            'stats': {'agi': (21, 3),
 ...
 'snake': {'body': BodyType.SNAKE,
           ...
           'stats': {'agi': (10, 4),
                     ...
                     'str': (1, 5),
                     'wis': (31, 2)}},
 'strider': {'body': BodyType.HUMANOID,
             'language': 'English',
             'mass': 400.0,
             'size': BodySize.HUGE,
             'stats': {'agi': (50, 1),
                       ...
                       'str': (90, 1),
                       'wis': (1, 3)}},
 'tortoise': {'body': BodyType.QUADRUPED,
              'language': 'Tortois',
              'mass': 3.6,
              'size': BodySize.SMALL,
              'stats': {'agi': (10, 4),
 ...
 'troll': {'body': BodyType.HUMANOID,
           ...
           'stats': {'agi': (10, 2),
                     ...
                     'str': (50, 1),
                     'wis': (5, 5)}},
 'unicorn': {'body': BodyType.QUADRUPED,
             'language': 'Cornequine',
             'mass': 160.0,
             'size': BodySize.LARGE,
             'stats': {'agi': (31, 2),
