...
class TestSoul(unittest.TestCase):
    ...
    def testUnknownVerb(self):
        ...
        with self.assertRaises(tale.errors.UnknownVerbException) as ex:
            parsed = ParseResult("_unknown_verb_")
    ...
    def testExternalVerbs(self):
        ...
        self.assertIsInstance(x.exception.parsed, ParseResult)
    ...
    def testQualifier(self):
        ...
        parsed = ParseResult("scream", qualifier="don't", message="I have no idea")
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
    ...
    def testDEFA(self):
        ...
        # drool
        parsed = ParseResult("drool", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
    ...
    def testPREV(self):
        ...
        self.assertEqual("Julie peers at you.", target_msg)
        # tease
        parsed = ParseResult("tease", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
        ...
        # turn
        parsed = ParseResult("turn", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
    ...
    def testPHYS(self):
        ...
        with self.assertRaises(tale.errors.ParseError):
            ...
            soul.process_verb_parsed(player, parsed)
        # pounce
        parsed = ParseResult("pounce", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
        ...
        # hold
        parsed = ParseResult("hold", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
    ...
    def testPERS(self):
        ...
        # fear2
        parsed = ParseResult("fear", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
    ...
    def testSIMP(self):
        ...
        # scream 2
        parsed = ParseResult("scream", who_order=targets)
        ...
        # ask
        parsed = ParseResult("ask", message="are you happy", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
    ...
    def testDEUX(self):
        ...
        player = tale.player.Player("julie", "f")
        # die
        parsed = ParseResult("die", adverb="suddenly")
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
        ...
        # ah
        parsed = ParseResult("ah", adverb="rudely")
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
    ...
    def testQUAD(self):
        ...
        # watch2
        parsed = ParseResult("watch", who_order=targets)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
        ...
        parsed = ParseResult("ayt", who_order=targets2)
        who, player_msg, room_msg, target_msg = soul.process_verb_parsed(player, parsed)
