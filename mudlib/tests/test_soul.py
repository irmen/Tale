...
class TestSoul(unittest.TestCase):
    ...
    def testQUAD(self):
        ...
        # ayt
        who, player_message, room_message, target_message = soul.process_verb_parsed(player, "ayt", targets)
        self.assertEqual(targets, who)
        self.assertEqual("you wave your hand in front of max' face, is he there?", player_message)
        self.assertEqual("julie waves her hand in front of max' face, is he there?", room_message)
        self.assertEqual("julie waves her hand in front of your face, are you there?", target_message)
        # ayt
        targets2 = [mudlib.npc.NPC("max","m"), player]
        who, player_message, room_message, target_message = soul.process_verb_parsed(player, "ayt", targets2)
        self.assertEqual("you wave your hand in front of max' and your own face, are they there?", player_message)
        self.assertEqual("julie waves her hand in front of max' and her own face, are they there?", room_message)
        self.assertEqual("julie waves her hand in front of your face, are you there?", target_message)
